...
--
-- Host: 127.0.0.1
-- Generation Time: 2019-01-17 14:56:42
-- 服务器版本： 5.7.9
-- PHP Version: 7.0.0
...
) ENGINE=InnoDB AUTO_INCREMENT=106 DEFAULT CHARSET=utf8 COMMENT='权限授权表';
...
DROP TABLE IF EXISTS `cmf_dir_file`;
CREATE TABLE IF NOT EXISTS `cmf_dir_file` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `cmf_file_recycle`;
CREATE TABLE IF NOT EXISTS `cmf_file_recycle` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `cmf_file_tag`;
CREATE TABLE IF NOT EXISTS `cmf_file_tag` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `file_id` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '文件ID',
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='全站配置表' ROW_FORMAT=COMPACT;
...
CREATE TABLE IF NOT EXISTS `cmf_school` (
...
DROP TABLE IF EXISTS `cmf_share`;
CREATE TABLE IF NOT EXISTS `cmf_share` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '分享链接id',
  `user_id` bigint(20) UNSIGNED NOT NULL DEFAULT '0' COMMENT '用户id',
...
DROP TABLE IF EXISTS `cmf_share_file`;
CREATE TABLE IF NOT EXISTS `cmf_share_file` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=64 DEFAULT CHARSET=utf8mb4 COMMENT='用户表';
...
CREATE TABLE IF NOT EXISTS `cmf_user_score_log` (
  ...
  `coin` int(11) NOT NULL DEFAULT '0' COMMENT '更改金币，可以为负',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='用户操作积分等奖励日志表';
...
CREATE TABLE IF NOT EXISTS `cmf_verification_code` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COMMENT='手机邮箱数字验证码表';
